...
<body>
    <div class="container mt-2">
        ...
        <form action="update.php" method="post">
            ...
            <input type="text" name="ine" class="form-control mb-3" placeholder="Escribe tu INE" value="<?php echo $alumno['ine']; ?>">
            <input type="text" name="nombre" class="form-control mb-3" placeholder="Escribe tu nombre" value="<?php echo $alumno['nombre']; ?>">
            <input type="text" name="apellidos" class="form-control mb-3" placeholder="Escribe tus apellidos" value="<?php echo $alumno['apellidos']; ?>">
